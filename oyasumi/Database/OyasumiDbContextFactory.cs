...
{
    // Thanks to Mempy https://github.com/osuAkatsuki/Sora/blob/master/src/Sora/Database/SoraDbContextFactory.cs
    // Modified version of https://github.com/ppy/osu/blob/master/osu.Game/Database/DatabaseContextFactory.cs under MIT License!
    public class OyasumiDbContextFactory
    {
        ...
        private ThreadLocal<OyasumiDbContext> threadContexts;

        public OyasumiDbContextFactory()
        {
        ...
        /// </summary>
        public OyasumiDbContext Get() => threadContexts.Value;
        ...
        private void recycleThreadContexts()
        {
            ...
            threadContexts = new ThreadLocal<OyasumiDbContext>(CreateContext, true);
        }

        protected virtual OyasumiDbContext CreateContext()
            => new OyasumiDbContext { Database = { AutoTransactionsEnabled = false } };
